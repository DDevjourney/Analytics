...
Ingresar una URL válida en el input y presionar el botón Check.

Ver los resultados con barras animadas y gradientes que reflejan la puntuación de cada métrica.
